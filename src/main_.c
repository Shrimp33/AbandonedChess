...
DllExport Piece createPiece(char class, char color, int x, int y) {
    Piece piece;
    piece.class = class;
...
DllExport ChessBoard *createChessBoard(bool isWhite) {  // TODO: create a chess board with black
...
DllExport char *getPiece(ChessBoard *chessBoard, int x, int y) {
    static char piece[2];
    printf("%p\n", &chessBoard);
    printf("%ld\n", &chessBoard);
}
...
DllExport bool isValidMove(ChessBoard *chessBoard, int x1, int y1, int x2, int y2) {
